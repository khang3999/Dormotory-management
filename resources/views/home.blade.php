        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="i-event-image"></div>
                    <div class="i-event-title">Title is here</div>
                    <div class="i-event-text">
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Blanditiis et voluptates enim modi
                        quas esse expedita fugit laudantium. Laborum enim ex cum provident dignissimos nemo deserunt
                        nostrum temporibus placeat quia?
                    </div>
                </div>
                <div class="col-12 col-md-4 mb-4">
                    <div class="i-event-image"></div>
